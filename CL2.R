...
samplesize <- 50
attach ( data1 )
female_smokers = split(data1,gender)$"Female"
male_smokers = split(data1,gender)$"Male"
...
#Question 2
Week_average = mean(data1$amt_weekends+data1$amt_weekdays)
var_data_week = 1/49*sum((data1$amt_weekends+data1$amt_weekdays-Week_average)**2)
Upperalpha = -1.65
